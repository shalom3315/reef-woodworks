...
const DEFAULT_SETTINGS: SiteSettings = {
  ...
  benefits_2_desc: 'כל פרויקט מותאם בדיוק לצרכים, לחלל ולסגנון הייחודי שלכם – ממידות ועד גוון העץ.',
  benefits_3_accent: 'ליווי לאורך כל הדרך',
  benefits_3_title: 'שירות אישי',
  benefits_3_desc: 'מהשיחה הראשונה ועד השלמת הפרויקט – אנחנו כאן. עם תשובה מהירה לכל שאלה ועדכון שוטף.',
}
