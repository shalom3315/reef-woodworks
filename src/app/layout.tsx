    ...
    <html lang="he" dir="rtl" className={`${frank.variable} ${heebo.variable}`}>
      <body className="font-body bg-cream text-charcoal antialiased">
        ...
        <a
          ...
          title="Shalom · 055-675-2495"
          className="fixed bottom-6 left-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white text-xs font-medium px-3.5 py-2.5 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
        >
